...
<head>
    ...
    @elseif(Request::route()->getName() == "add_product" || Request::route()->getName() == "edit_product")
        ...
        <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/sweetalert2@8/dist/sweetalert2.min.css"
              id="theme-styles">
    @elseif(Request::route()->getName() == "communication")
...
<div id="main-wrapper">
    ...
    <div class="mobile_search">
        <form class="" action="/search" method="post">
            @csrf
            <input type="text" class="form-control" id="mobilesearch" name="keyword" placeholder="Search"
                   style="display: none;">
        </form>
    </div>
...
<script src="{{asset('assets/js/loop_counter.js')}}"></script>
...
@elseif(Request::route()->getName() == "my_sales")
    <script src="{{asset('assets/js/customer/my_sales.js')}}"></script>
@elseif(Request::route()->getName() == "my_order")
    <script src="{{asset('assets/js/customer/my_order.js')}}"></script>
@elseif(Request::route()->getName() == "return_request")
    <script src="{{asset('assets/js/customer/return_request.js')}}"></script>
@elseif(Request::route()->getName() == "my_subscription")
    <script src="{{asset('assets/js/customer/my_subscription.js')}}"></script>
@elseif(Request::route()->getName() == "add_product" || Request::route()->getName() == "edit_product")
...
@elseif(Request::route()->getName() == "communication")
   {{-- <script src="//code.jquery.com/jquery-2.2.0.min.js"></script>--}}
    ...
    <script src="{{ asset('js/jquery.loadTemplate-1.4.4.min.js') }}"></script>
    <script src="//maxcdn.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.min.js"></script>
    <script src="//cdnjs.cloudflare.com/ajax/libs/moment.js/2.11.1/moment.min.js"></script>
    <!-- Twilio Common helpers and Twilio Chat JavaScript libs from CDN. -->
    <script src="//media.twiliocdn.com/sdk/js/common/v0.1/twilio-common.min.js"></script>
    <script src="https://media.twiliocdn.com/sdk/js/chat/releases/3.3.2/twilio-chat.min.js"></script>
...
@elseif(Request::route()->getName() == "myproducts")
    <script src="{{asset('assets/js/customer/product_list.js')}}"></script>
@endif
