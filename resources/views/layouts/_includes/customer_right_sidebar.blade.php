        ...
        <div class="r-panel-body">
            ...
            <div class="user_settings">
                <ul>
                    <li>
                        <b>
                            <span style="color: #ec038d">Sell to </span> <span style="font-size:20px; color:green">*</span>
                        </b>
                    </li>
                    <li>
                        <div class="btn-group sell_to_friends" data-toggle="buttons" onclick="sell_to_friends()">
                            <label class="btn sell_to_friends" style="padding:0px;">
                                ...
                                <input type="checkbox" name="sell_to_friends" class="custom-control-input checkbox-danger friendinput" id="sell_to_friends" value="sell to friend to database" @if($sellingoption[0]['sell_to_friend']=='1') {{'checked'}} @endif>
                                <label class="custom-control-label text-danger" for="sell_to_friends">Friends</label>
                                </div>
                            </label>
                            <br>
                        </div>
                            ...
                            <div class="btn-group sell_to_friends_of_friends" data-toggle="buttons" onclick="updategroupsellto({{$friendgroup->id}});">
                            <label class="btn sell_to_{{$friendgroup->id}}" style="padding:0px;">
                            <div class="custom-control custom-checkbox mr-sm-2">
                            <input type="checkbox" class="custom-control-input checkbox-info" id="sell_to_{{$friendgroup->id}}" @if($friendgroup->sell_to=='1') {{'checked'}} @endif>
                            <label class="custom-control-label text-info" for="sell_to_{{$friendgroup->id}}">{{$friendgroup->group_name}}</label>
                            </div>
                            </label>
                        </div> 
                            @endforeach
                        <div class="btn-group sell_to_neighbours" data-toggle="buttons" onclick="sell_to_neighbours()">
                            <label class="btn sell_to_neighbours" style="padding:0px;">
                                <div class="custom-control custom-checkbox mr-sm-2">
                                    <input type="checkbox" class="custom-control-input" id="sell_to_neighbours" @if($sellingoption[0]['sell_to_neighbour']=='1') {{'checked'}} @endif>
                                    <label class="custom-control-label text-purple" for="sell_to_neighbours">Neighbours</label>
                                </div>
                            </label>
                        </div>
                        ...
                        <div class="btn-group sell_to_uk" data-toggle="buttons" onclick="sell_to_uk()">
                            <label class="btn sell_to_uk" style="padding:0px;">
                                <div class="custom-control custom-checkbox mr-sm-2">
                                    <input type="checkbox" class="custom-control-input" id="sell_to_uk" @if($sellingoption[0]['sell_to_uk']=='1') {{'checked'}} @endif>
                                    <label class="custom-control-label text-success" for="sell_to_uk">{{Auth::user()->country}}</label>
                                </div>
                            </label>
                        </div>
                    </li>
                ...
                <ul>
                    <li>
                        <b>
                            <span style="color: #ec038d">Lend to </span><span style="font-size:20px; color:green">*</span>
                        </b>
                    </li>
                    <li>
                        <div class="btn-group lend_to_friends" data-toggle="buttons" onclick="lend_to_friends()">
                            ...
                            <div class="custom-control custom-checkbox mr-sm-2 ">
                            <input type="checkbox" class="custom-control-input checkbox-danger" id="lend_to_friends" @if($sellingoption[0]['lend_to_friend']=='1') {{'checked'}} @endif>
                            <label class="custom-control-label text-danger" for="lend_to_friends">Friends</label>
                            </div>
                            </label><br>
                        </div>
                         @foreach($friend_groups as $friendgroup)
                            <div class="btn-group sell_to_friends_of_friends" data-toggle="buttons" onclick="updategrouplendto({{$friendgroup->id}});">
                            <label class="btn sell_to_{{$friendgroup->id}}" style="padding:0px;">
                            <div class="custom-control custom-checkbox mr-sm-2">
                            <input type="checkbox" class="custom-control-input checkbox-info" id="lend_to_{{$friendgroup->id}}" @if($friendgroup->lend_to=='1') {{'checked'}} @endif>
                            <label class="custom-control-label text-info" for="lend_to_{{$friendgroup->id}}">{{$friendgroup->group_name}}</label>
                            </div>
                            </label>
                        </div> 
                            @endforeach
 ...
 -->
                        <div class="btn-group lend_to_neighbours" data-toggle="buttons" onclick="lend_to_neighbours()">
                            <label class="btn lend_to_neighbours" style="padding:0px;">
                                <div class="custom-control custom-checkbox mr-sm-2">
                                    <input type="checkbox" class="custom-control-input" id="lend_to_neighbours" @if($sellingoption[0]['lend_to_neighbour']=='1') {{'checked'}} @endif>
                                    <label class="custom-control-label text-purple" for="lend_to_neighbours">Neighbours</label>
                                </div>
                            </label>
                        </div>
                        ...
                        <div class="btn-group lend_to_uk" data-toggle="buttons" onclick="lend_to_uk()">
                            <label class="btn lend_to_uk" style="padding:0px;">
                                <div class="custom-control custom-checkbox mr-sm-2">
                                    <input type="checkbox" class="custom-control-input" id="lend_to_uk" @if($sellingoption[0]['lend_to_uk']=='1') {{'checked'}} @endif>
                                    <label class="custom-control-label text-success" for="lend_to_uk">{{Auth::user()->country}}</label>
                                </div>
                            </label>
                        </div>
                    </li>
            ...
            <ul id="themecolors" class="m-t-20">
                ...
                <li>
                    ...
                    @if(count($user_hrs) > 0)
                        ...
                        @foreach($user_hrs as $hrs)
                            <li id="hour_id_{{$hrs['id']}}" style="font-size:10px">{{ucwords($hrs['user_day_name'])}} ({{date("g:i a", strtotime($hrs['user_start_time']))}} - {{date("g:i a", strtotime($hrs['user_end_time']))}})    <span class="text-danger" data-user_hr_id="{{$hrs['id']}}" onclick="removeOpenHour(this);"> <i class="fa fa-trash" aria-hidden="true"></i> </span>  </li>
                        @endforeach
                ...
                <ul class="hours-select clearfix inline-lasyout up-4" style="font-size:10px;">
                    ...
                    <li>
                        <button class="btn btn-rounded btn-info  add_opening_times" onclick="add_opening_times(this);">Add Opening Hours</button>
                    </li>
                    <br>
