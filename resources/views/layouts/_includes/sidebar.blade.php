<div class="o-page__sidebar js-page-sidebar">
	<div class="c-sidebar">
		<a class="c-sidebar__brand" href="{{url('/')}}">
			<img class="c-sidebar__brand-img" src="{{ asset('assets/images/logo-icon.png') }}" alt="Logo">
		...
		<ul class="c-sidebar__list">
			...
			<li class="c-sidebar__item">
				<a class="c-sidebar__link" href="{{url('/customers')}}">
					<i class="fa fa-user-o u-mr-xsmall"></i>Customers
				</a>
			</li>
