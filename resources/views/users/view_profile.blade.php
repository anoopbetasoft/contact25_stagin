            ...
            <div class="card">
                ...
                <div class="">
                    <ul class="nav nav-tabs profile-tabs" role="tablist">
                        <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#home2" role="tab"><span class="hidden-sm-up"><i class="mdi mdi-account"></i></span> <span class="hidden-xs-down">Profile</span></a> </li>
                        <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#holiday2" role="tab"><span class="hidden-sm-up"><i class="mdi mdi-airplane-takeoff"></i></span> <span class="hidden-xs-down">Holiday</span></a> </li>
                        <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#delivery" role="tab"><span class="hidden-sm-up"><i class="mdi mdi-truck"></i></span> <span class="hidden-xs-down">Delivery</span></a> </li>
                        <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#communication" role="tab"><span class="hidden-sm-up"><i class="mdi mdi-email"></i></span> <span class="hidden-xs-down">Communication</span></a> </li>
                        <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#profile2" role="tab"><span class="hidden-sm-up"><i class="mdi mdi-key"></i></span> <span class="hidden-xs-down">Security</span></a> </li>
