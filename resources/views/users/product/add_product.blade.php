            ...
            <div class="panel-heading">
                <h4 class="m-b-0 text-white"><i class="fa fa-plus" style="font-size:22px;cursor: pointer;"></i>
                    <span style="float:right;"> 
                        <span class="barcode_wrapper"></span><i class="barcode_scan fa fa-barcode" style="font-size:26px; cursor:pointer;" onclick="barcode_scan();"></i>
                    </span>
                </h4>
            </div>
            <div class="card-body">
                <form id="add_product" enctype="multipart/form-data">
                    ...
                    <div class="row p-t-20">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="fileupload btn waves-effect waves-light text-info" style="float:left; width:100%; font-size:30px; border: 1px solid #03a9f3;">
                                <span>
                                    <i class="fa fa-upload"></i> 
                                    <span class="hidden-xs">Upload  Image</span>
                                </span>
                                <input type="file" name="p_images[]"  id="imgInp" class="upload" data-default-file="" multiple />
