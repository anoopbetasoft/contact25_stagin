        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input class="form-control"name="name" type="text" placeholder="Jason" value="{{$uDetails[0]['name']}}" required="required">
                    <span id="name"></span>
                </div>
            </div>
            <!--/span-->
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input class="form-control" name="email"  type="email" placeholder="jason@clark.com" value="{{$uDetails[0]['email']}}" >
                    <span id="email"></span>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input class="form-control"name="st_address1" type="text" placeholder="Street Address 1" value="{{$uDetails[0]['street_address1']}}" required="required">
                </div>
                <div class="form-group">
                    <label class="control-label">Street Address 2</label>
                    <input class="form-control"name="st_address2" type="text" placeholder="Street Address 2" value="{{$uDetails[0]['street_address2']}}">
                    <!-- <span id="name"></span> -->
                </div>
            </div>
            <!--/span-->
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input class="form-control" name="city"  type="text" placeholder="City" value="{{$uDetails[0]['city']}}" >
                    <span id="city"></span>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input class="form-control" name="state"  type="text" placeholder="County/State" value="{{$uDetails[0]['state']}}" required="required">
                    <span id="state"></span>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input class="form-control" name="pincode"  type="text" placeholder="Postcode/Zip" value="{{$uDetails[0]['pincode']}}" required="required">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="hidden" name="country" value="{{$uDetails[0]['country']}}">
                    @endif
                    <select name="country" class="selectpicker" data-style="form-control btn-secondary" required="required" <?php if($pendingordercount>0){ echo "disabled"; } ?> id="countrylist">
                    @foreach($country as $c)
                        <option value="{{$c['c_name']}}" @if($c["c_name"] == $uDetails[0]['country']) selected="selected" @endif>{{$c['c_name']}}</option>
                    @endforeach
                    </select>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    @endif
                    <select name="currency_code" class="selectpicker" data-style="form-control btn-secondary" required="required" <?php if($pendingordercount>0){ echo "disabled"; } ?>>
                    @foreach($currencies as $c)
                        <option value="{{$c['code']}}" @if($c["code"] == $uDetails[0]['currency_code']) selected="selected" @endif>{{$c['code']}}[{{$c['symbol']}}]</option>
                    @endforeach
                    </select>
                    <span id="country"></span>
                </div>
...
<div class="col-md-12 location_service">
    <div class="form-group">
    	<br>
        <label class="control-label text-success" style="font-size:24px"> <i class="ti-location-pin" style="color:#00c292"></i> Location</label><br><p>Search for your home location (usually using your postal address). We need this so that we can send buyers directions to your home location to collect things you sell.</p>
       ...
       @endif
       <input type="hidden" name="latlng" id="latlng" value="({{$uDetails[0]['lat']}},{{$uDetails[0]['lng']}})">
        <input type="hidden" id="location_coord" name="p_service_location" value="">
        <input id="pac-input" class="form-control input_types" name="location" placeholder="Location" type="text" value="{{$uDetails[0]['location']}}">
        <div id="map"></div>
    </div>
</div>
        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="dropify-errors-container">
                        @if(empty($uDetails[0]['avatar']))
                            <input type="file" name="avatar" id="input-file-now-custom-1"  class="dropify" data-default-file="" />
                        @else
                            ...
                            @if($uDetails[0]['avatar_type'] == 1)
                                <input type="file" name="avatar"  id="input-file-now-custom-1" class="dropify" data-default-file='{{asset("uploads/avatar/$img_name")}}' width="100%">
                            @elseif($uDetails[0]['avatar_type'] == 2) 
                                <input type="file" name="avatar"  id="input-file-now-custom-1" class="dropify" data-default-file='{{$img_name}}' width="100%">
