...
@section('content')
    ...
    <div class="row">
            @if(count($orderdetails) > 0)
                                   ...
                                   @elseif($order['o_tracking_no']!='')
                                    ...
                                    @endif
                                        ...
                                        <div id="action{{$order['id']}}">
                                            @if($order['subs_status']=='1')
                                   <div id="cancelorder{{$order['id']}}"><span class="font-normal">Cancel Subscription : </span><button class="btn btn-danger" onclick="cancelsubscription('{{$order['id']}}');"> <!-- If the user is seller and item is not collected or dispatched -->
                            Cancel Subscription
                ...
                @endforeach
            @else
                <p>You have not subscribed to any service yet</p>
            @endif
